    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button
          variant='ghost'
          size='icon'
          className='md:hidden text-yellow-400 hover:text-yellow-300 hover:bg-transparent'
        >
      ...
      <SheetContent
        side='right'
        className='w-80 bg-black/95 backdrop-blur-xl border-l border-yellow-400/20'
      >
        <SheetHeader>
          <SheetTitle className='text-yellow-400 text-xl font-bold tracking-wide'>
            Navegación
          </SheetTitle>
        </SheetHeader>
        <div className='flex flex-col space-y-6 mt-12'>
          ...
          <div className='mt-12 pt-6 border-t border-yellow-400/20'>
            <p className='text-yellow-400 font-bold text-base mb-6 tracking-wide'>
              {t("freeConsultation")}
            </p>
