      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex items-center space-x-6 text-sm text-gray-300">
            <span className="font-medium">© 2024 duck3. {t('allRightsReserved')}</span>
            <a href="#" className="hover:text-yellow-400 transition-colors font-medium">{t('privacy')}</a>
            <a href="#" className="hover:text-yellow-400 transition-colors font-medium">{t('terms')}</a>
          </div>
        </div>
      </div>
    </footer>
